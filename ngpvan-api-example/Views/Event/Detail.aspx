...
<body>
    <fieldset>
        ...
        <p>
            ...
            <%= Html.Label("Is active", new { @class="editor-label"}) %> <%= Html.CheckBox("isActive", Model.IsActive, new { @class="editor-field", @readonly = "readonly"}) %><br/><br/>
            
            <% if (Model.Locations != null) {%>
            <%= Html.Label("Locations", new { @class="editor-label"}) %><br/>
            <% foreach (var location in Model.Locations)
               { %>
                <%= Html.TextArea("displayName", location.DisplayName, new { @class="editor-field", @readonly = "readonly"}) %> <br/>
            <% } %>
            <% } %>
        </p>
    </fieldset>
